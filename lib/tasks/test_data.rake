namespace :app do
  ...
  Activity.new({name:"Multiplication", description: "ThatQuiz", instructions: "90%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 70, benchmark2_score: 90 }).save
  Activity.new({name:"Division", description: "ThatQuiz", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"Long Division1", description: "ThatQuiz", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"Long Division2", description: "ThatQuiz", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"Long Division3", description: "ThatQuiz", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"Multiplication without carrying", description: "Khan", instructions: "5 in a row", teacher_user_id: demo_teacher.id, activity_type: "completion", min_score: nil ,max_score: nil, benchmark1_score: nil, benchmark2_score: nil }).save
  Activity.new({name:"Multiplication with carrying", description: "Khan", instructions: "5 in a row", teacher_user_id: demo_teacher.id, activity_type: "completion", min_score: nil ,max_score: nil, benchmark1_score: nil, benchmark2_score: nil }).save
  Activity.new({name:"Multiplying 2 digits by 2 digits", description: "Khan", instructions: "5 in a row", teacher_user_id: demo_teacher.id, activity_type: "completion", min_score: nil ,max_score: nil, benchmark1_score: nil, benchmark2_score: nil }).save
  Activity.new({name:"Multi-digit division without remainders", description: "Khan", instructions: "5 in a row", teacher_user_id: demo_teacher.id, activity_type: "completion", min_score: nil ,max_score: nil, benchmark1_score: nil, benchmark2_score: nil }).save
  Activity.new({name:"Division with remainders", description: "Khan", instructions: "5 in a row", teacher_user_id: demo_teacher.id, activity_type: "completion", min_score: nil ,max_score: nil, benchmark1_score: nil, benchmark2_score: nil }).save
  Activity.new({name:"Multiplication and division word problems", description: "Khan", instructions: "5 in a row", teacher_user_id: demo_teacher.id, activity_type: "completion", min_score: nil ,max_score: nil, benchmark1_score: nil, benchmark2_score: nil }).save
  Activity.new({name:"GCF", description: "Khan", instructions: "5 in a row", teacher_user_id: demo_teacher.id, activity_type: "completion", min_score: nil ,max_score: nil, benchmark1_score: nil, benchmark2_score: nil }).save
  Activity.new({name:"L3: Fluently Solve Multiplication Problems", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L3: Fluently Solve Division Problems", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L3: Solving Multiplication and Division Verbally", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L4: Multiplication and Division Strategies", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L4: Factors", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L4: Relating Multiplication and Division", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L5: Multiplication with Multi-Digit Whole Numbers", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L5: Dividing Whole Numbers", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L5: Complete Equivalent Fractions", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L5: Finding Equivalent Fractions and Fractions in Simplest Form", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L6: Identifying the Least Common Multiple", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
  Activity.new({name:"L6: Identifying the Greatest Common Factor", description: "TenMarks", instructions: "80%+", teacher_user_id: demo_teacher.id, activity_type: "scored", min_score: 0 ,max_score: 100, benchmark1_score: 60, benchmark2_score: 80 }).save
